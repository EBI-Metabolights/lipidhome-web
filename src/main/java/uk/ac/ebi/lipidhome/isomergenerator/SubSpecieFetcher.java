...
import uk.ac.ebi.lipidhome.isomergenerator.models.FattyAcidSpecie;
...
public class SubSpecieFetcher {
    ...
    public SubSpecie getSubSpecie() {
        try{
            ...
            props.put("password", "L1pid0Mic#");
            //props.put("user", "root");
            //props.put("password", "lepassword");
            Connection con = driver.connect("jdbc:mysql://mysql-lnet.ebi.ac.uk:4265/lipidhomeTest", props);
            //Connection con = driver.connect("jdbc:mysql://localhost:3306/lipidhomeTest", props);
